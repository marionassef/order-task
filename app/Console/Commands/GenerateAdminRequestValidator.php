...
class GenerateAdminRequestValidator extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:adminRequestValidator {name}';
     ...
     * @var string
     */
    protected $description = 'generate Admin Request Validator';
...
//    }
    ...
    public function handle()
    {
        ...
        $this->callSilent('make:request'. $className.'Request');
